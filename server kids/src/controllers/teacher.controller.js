...
const verifyEmail = async (Email, Firstname, createdTeacherId) => {
    try {
        ...
        const mailOptions = {
            ...
            <br>
            <a href="http://localhost:8888/api/teacher/verify?id=${createdTeacherId}">
...
const addTeacherDetails = asyncHandler(async(req,res)=>{
    ...
    console.log("AadhaarLocalPath", AadhaarLocalPath,"SecondaryLocalPath",SecondaryLocalPath,"HigherLocalPath", HigherLocalPath,"UGLocalPath", UGLocalPath, PGLocalPath);
    ...
    console.log("Aadhaar", Aadhaar,"Secondary",Secondary,"Higher", Higher,"UG", UG, PG);
